            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="temp2.php" class="btn btn-secondary">글쓰기</a>
                    </div>
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?>">
                                    <a class="page-link" href="temp.php?page=<?php echo $prevGroup; ?>&postsPerPage=<?php echo $postsPerPage; ?>">이전</a>
                                </li>
                                <?php for ($i = $firstPage; $i <= $lastPage; $i++): ?>
                                    <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
                                        <a class="page-link" href="temp.php?page=<?php echo $i; ?>&postsPerPage=<?php echo $postsPerPage; ?>"><?php echo $i; ?></a>
                                    </li>
                                <?php endfor; ?>
                                <li class="page-item <?php if ($page >= $totalPages) echo 'disabled'; ?>">
                                    <a class="page-link" href="temp.php?page=<?php echo $nextGroup; ?>&postsPerPage=<?php echo $postsPerPage; ?>">다음</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.board-row').forEach(row => {
            row.addEventListener('click', function() {
                ...
                window.location.href = `board_view.php?id=${id}`;
            });
        });
    </script>
</body>
